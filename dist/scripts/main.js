...
const nome = "Jean Pablo Alves Gon\xe7alves";
...
function typeEffectH2() {
    if (escrevendo) {
        ...
        } else setTimeout(typeEffectH2, 100); // Velocidade de escrita
    } else {
        h2Elemento.innerHTML = nome.slice(0, --charIndex);
        if (charIndex === 0) {
            escrevendo = true;
            setTimeout(typeEffectH2, 500);
        } else setTimeout(typeEffectH2, 100);
    }
}
typeEffectH2();

},{}]},["8bDoD","3cYfC"], "3cYfC", "parcelRequire78ce")
